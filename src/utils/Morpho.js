...
class Morpho {
  ...
  static lconjopt(optLabel) {
    switch (optLabel) {
      case "Pronoun":
        return this._gPpOpts();
      case "Negation":
        return this._gNegOpts();
      case "Voice":
        return this._gVoiceOpts();
      default:
        return [{}];
    }
  }
  ...
  static goptname(optLabel, opts) {
    switch (optLabel) {
      case "Pronoun":
        return this._gPpName(opts);
      case "Negation":
        return this._gNegName(opts);
      case "Voice":
        return this._gVoiceName(opts);
      default:
    }
    return "";
  }
